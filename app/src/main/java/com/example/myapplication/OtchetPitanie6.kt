...
import kotlinx.android.synthetic.main.activity_otchet_pitanie6.*

class OtchetPitanie6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_otchet_pitanie6)

         monday6.setOnClickListener { val first=Intent(this, OtchetPitanie::class.java)
     startActivity(first)}

        tuesday6.setOnClickListener { val second= Intent(this, OtchetPitanie2::class.java)
       ...
       /* imageButton17.setOnClickListener { val six= Intent(this, OtchetPitanie6::class.java)
        ...
        sunday6.setOnClickListener { val seven= Intent(this, OtchetPitanie7::class.java)
            startActivity(seven)}
