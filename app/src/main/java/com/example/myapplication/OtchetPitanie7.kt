...
import kotlinx.android.synthetic.main.activity_otchet_pitanie7.*

class OtchetPitanie7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_otchet_pitanie7)

         monday7.setOnClickListener { val first=Intent(this, OtchetPitanie::class.java)
     startActivity(first)}

        tuesday7.setOnClickListener { val second= Intent(this, OtchetPitanie2::class.java)
